...
const Hero = ({ darkMode }) => {
  ...
  return (
    <section id="home" className="relative h-screen overflow-hidden">
      ...
      <div
        className={`absolute inset-0 z-0 ${darkMode
      ...
      <div className={`absolute top-1/4 -left-20 w-80 h-80 rounded-full blur-3xl z-0 opacity-30 ${darkMode ? 'bg-blue-500' : 'bg-blue-300'
        }`}></div>

      <div className={`absolute bottom-1/4 -right-20 w-80 h-80 rounded-full blur-3xl z-0 opacity-30 ${darkMode ? 'bg-cyan-500' : 'bg-blue-400'
        }`}></div>
      ...
      <div className="absolute inset-0 z-0 overflow-hidden flex items-center justify-center">
        <span className={`text-9xl font-mono opacity-5 transform -translate-x-40 ${darkMode ? 'text-cyan-400' : 'text-blue-600'
          }`}>{'{'}</span>
        <span className={`text-9xl font-mono opacity-5 transform translate-x-40 ${darkMode ? 'text-cyan-400' : 'text-blue-600'
          }`}>{'}'}</span>
      </div>
      ...
      <div className="container mx-auto px-4 h-full z-10 relative">
        ...
        >
          <div className={`p-8 rounded-lg ${darkMode
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="h-8">
                  <h2 id="typing-role" className={`text-xl md:text-2xl font-semibold ${darkMode ? 'text-cyan-400' : 'text-blue-600'
                    }`}> </h2>
                </div>
              </div>
              ...
              <p className={`text-lg ${darkMode ? 'text-gray-300' : 'text-gray-700'
                ...
                With {yearsExperience}+ years of experience in frontend development, I specialize in creating performant, accessible, and visually appealing web applications. 
                Currently at Liv-ex, a global online wine marketplace, I'm one of two React developers responsible for the development of the trading platform. 
                My role encompasses the entire development lifecycle, from conceptualization to deployment and release management.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <Link
                  ...
                  duration={500}
                  offset={-70}
                  className={`px-8 py-4 rounded-md font-semibold transition-all transform hover:scale-105 text-center ${darkMode
            ...
            <div className={`mt-12 flex flex-wrap gap-3 ${darkMode ? 'text-gray-400' : 'text-gray-600'
              }`}>
              <span className={`px-3 py-1 rounded-full text-xs ${darkMode ? 'bg-gray-800 text-cyan-400' : 'bg-blue-100 text-blue-700'
                }`}>React.js</span>
              <span className={`px-3 py-1 rounded-full text-xs ${darkMode ? 'bg-gray-800 text-cyan-400' : 'bg-blue-100 text-blue-700'
                }`}>JavaScript</span>
              <span className={`px-3 py-1 rounded-full text-xs ${darkMode ? 'bg-gray-800 text-cyan-400' : 'bg-blue-100 text-blue-700'
          ...
          <div className={`mt-8 text-sm font-mono text-center ${darkMode ? 'text-gray-500' : 'text-gray-500'
            }`}>
